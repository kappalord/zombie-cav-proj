...
package com.scaleform.clikbrowser.controls {
    ...
    // Protected Methods:
        override protected function configUI():void {
            ...
            btnPrev.addEventListener(MouseEvent.CLICK, handlePrevClick);
            btnNext.addEventListener(MouseEvent.CLICK, handleNextClick);
        ...
        protected function populateData(data:Array):void {
            ...
            for (var i:uint = 0; i < data.length; i++) {
                ...
                tab.data = data[i];
                tab.autoSize = "left";
                tab.addEventListener(Event.SELECT, handleTabSelect);
                tab.x = tabx;
                tab.group = _group;
                tab.validateNow();
                tabx += tab.width;
